...
12. **BE-6:** Inventory submission endpoint

### Week 3: Async Processing + Admin UI
13. **BE-7:** Async analysis and email alerts
...
- Rate limiting on inventory submission (per IP, per QR)
